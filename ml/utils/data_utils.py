...
def handle_outliers(df: pd.DataFrame,
                    columns: List[str] = ["Conductivity", "Turbidity", "pH", "DissolvedOxygen"],
                    identifier: str = "District",
                    kwargs: Dict[str, Tuple] = {"upstream": (10, 90), "midstream": (10, 90), "downstream": (5, 95)},
...
def assign_statistics(X: pd.DataFrame,
                      stats: List[str],
                      lags: int = 10,
                      targets: List[str] = ["pH", "DissolvedOxygen"],
                      identifier: str = "District") -> Union[pd.DataFrame, None]:
